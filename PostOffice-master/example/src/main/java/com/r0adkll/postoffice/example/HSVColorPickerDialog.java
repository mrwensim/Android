...
public class HSVColorPickerDialog extends AlertDialog {
	...
	public interface OnColorSelectedListener {
		 ...
		 * possible if {@link com.r0adkll.postoffice.example.HSVColorPickerDialog#setNoColorButton(int) setNoColorButton()}
	 ...
	 * which will call the listener's {@link com.r0adkll.postoffice.example.HSVColorPickerDialog.OnColorSelectedListener#colorSelected(Integer) colorSelected(Integer)} callback
